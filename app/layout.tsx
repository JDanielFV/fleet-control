...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body className="min-h-full bg-background"><ConfirmProvider><ToastProvider><ErrorBoundary>
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[200] focus:px-4 focus:py-2 focus:bg-primary focus:text-white focus:rounded-xl focus:text-xs focus:font-bold"
        >
